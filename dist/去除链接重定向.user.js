...
/* harmony import */ var is_network_error__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29);
...
class BingProvider {
    ...
    resolve(aElement) {
        (0, utils_1.antiRedirect)(aElement, this.textDecoder.decode(Uint8Array.from(atob(aElement.href
            .split("&u=a1")[1]
            .split("&ntb=1")[0]
            .replace(/[-_]/g, (e) => ("-" === e ? "+" : "/"))
            .replace(/[^A-Za-z0-9\\+\\/]/g, ""))
...
const bing_com_1 = __webpack_require__(46);
const gm_http_1 = __webpack_require__(22);
